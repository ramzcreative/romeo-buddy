...
import { Scroll, InOut, Clip, InView, Parallax, Typewriter } from './transitions';
            ...
            if(key in optionsChecking){
              ...
              if(optionType == 'string'){
                if(typeof value === "string"){
                  ...
                  console.warn(`Motion Warning: Option of ${key} skipped, ${key} value (${value}) is not of type string.`);
                  continue;
                }
              }
                ...
                if(typeof value === "string" && isValidSelector(value)){
                  ...
                  console.warn(`Motion Warning: Option of ${key} skipped, ${key} value (${value}) is not a valid selector.`);
                  continue;
                }
              }
                ...
                if(typeof value === 'string' && NAMED.includes(value)){
                  ...
                  console.warn(`Motion Warning: Option of ${key} skipped, ${key} value (${value}) must be a bezier array of four numbers or one of: ${NAMED.join(', ')}.`);
                  continue;
                }
              }
                ...
                if(!Array.isArray(value)) {
                  console.warn(`Motion Warning: Option of ${key} skipped, ${key} value (${value}) is not of type array.`);
                  continue;
                }
                ...
                if(isFloat(value) || Number.isInteger(value)){
                  ...
                  console.warn(`Motion Warning: Option of ${key} skipped, ${key} value (${value}) is not of type number.`);
                  continue;
                }
              }
              ...
              if(optionsToCheck == 'OptionsResponsiveSimple')
                console.warn(`Motion Warning: Invalid option '${key}', not supported in breakpoint options.`);
              else
                console.warn(`Motion Warning: Invalid option '${key}'.`);
            }
          }
      }
    }
